#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# run_real_synthetic.sh
# Evaluate the real_synthetic fine-tuned model (qwen3-vl-8b @ port 8032) on
# the full Designer_supervision_assembly_testing.json dataset.
#
# Results → results_pose_real_synthetic/<task_id>/result.json
# Summary → results_pose_real_synthetic/summary_<timestamp>.json
#
...
#   bash run_real_synthetic.sh --thinking        # enable chain-of-thought
#   bash run_real_synthetic.sh --obj 77756       # single model
# ---------------------------------------------------------------------------
...
MODEL="real_synthetic"
RESULTS_DIR="results_pose_real_synthetic"

echo "============================================================"
echo "  Inference  :  $MODEL"
echo "  Endpoint   :  http://172.22.225.5:8032/v1  (qwen3-vl-8b)"
